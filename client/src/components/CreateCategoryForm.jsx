...
const CreateCategoryForm = () => {
    ...
    useEffect(() => {
        if (categoryType === 'subcategory') {
            ...
            const fetchParentCategories = async () => {
                try {
                    const response = await axios.get(`https://code-commanders.vercel.app/api/categories/get-parent-categories`);
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post(`https://code-commanders.vercel.app/api/categories/create-category`, {
                ...categoryData,
