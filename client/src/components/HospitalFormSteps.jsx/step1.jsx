...
const Step1 = ({ formData, setFormData, handleChange, handleNext }) => {
    ...
    useEffect(() => {
        const fetchCategories = async () => {
            try {
                const response = await axios.get(`https://code-commanders.vercel.app/api/categories/get-categories`);
                    ...
                    <div className="space-y-4 p-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className={`w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 ${errors.hospitalName ? "border-red-500 focus:ring-red-500" : "focus:ring-middleGreen"
                                    }`}
                            />
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    className={`w-full p-3 border rounded-md focus:outline-none focus:ring-2 ${errors.category ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-middleGreen'
                                        }`}
                                >
                        ...
                        <div>
                            ...
                            <div className="relative inline-block w-full mb-4">
                                <select
                                    ...
                                    className={`w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 ${errors.specialization ? "border-red-500 focus:ring-red-500" : "focus:ring-middleGreen"
                                        }`}
                                >
                        ...
                        <div>
                            ...
                            <div className="relative inline-block w-full mb-4">
                                <select
                                    ...
                                    className={`w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 ${errors.services ? "border-red-500 focus:ring-red-500" : "focus:ring-middleGreen"
                                        }`}
                                >
