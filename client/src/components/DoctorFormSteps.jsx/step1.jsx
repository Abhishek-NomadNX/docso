    ...
    const handleNextClick = async () => {
        try {
            ...
            const emailResponse = await axios.post(
                `https://code-commanders.vercel.app/api/doctors/check-email`,
    ...
    const sendVerificationCode = async () => {
        ...
        try {
            ...
            if (emailCheck.data.message === "Email is available") {
                try {
                    await axios.post(
                        `https://code-commanders.vercel.app/api/emailVerification/send-verification-code`,
                        { email: formData.email }
                    );
    ...
    const verifyEmailCode = async () => {
        try {
            const response = await axios.post(
                `https://code-commanders.vercel.app/api/emailVerification/verify-code`,
                    ...
                    <div className="space-y-4 text-left w-full p-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={handleChange}
                                required
                                className={`w-full p-3 border rounded-md focus:outline-none focus:ring-2 ${errors.registrationNo
                                        ? "border-red-500 focus:ring-red-500"
                                        : "border-gray-300 focus:ring-middleGreen"
                                    }`}
                            />
                        ...
                        <div>
                            ...
                            <select
                                ...
                                required
                                className={`w-full p-3 border rounded-md focus:outline-none focus:ring-2 ${errors.registrationCouncil
                                        ? "border-red-500 focus:ring-red-500"
                                        : "border-gray-300 focus:ring-middleGreen"
                                    }`}
                            >
                            ...
                            {isOtherCouncil && (
                                <div className="mt-2">
                                    ...
                                    <input
                                        ...
                                        onChange={handleChange}
                                        className={`w-full p-3 border rounded-md focus:outline-none focus:ring-2 ${errors.otherCouncil
                                                ? "border-red-500 focus:ring-red-500"
                                                : "border-gray-300 focus:ring-middleGreen"
                                            }`}
                                    />
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={handleChange}
                                required
                                className={`w-full p-3 border rounded-md focus:outline-none focus:ring-2 ${errors.registrationYear
                                        ? "border-red-500 focus:ring-red-500"
                                        : "border-gray-300 focus:ring-middleGreen"
                                    }`}
                            />
