    ...
    useEffect(() => {
        const fetchCategoryData = async () => {
            try {
                ...
                const response = await axios.get(`https://code-commanders.vercel.app/api/categories/search?categoryName=${categoryName}`);
                ...
                const hospitalPromises = categoryData.parentCategory.hospitals.map((id) =>
                    axios.get(`https://code-commanders.vercel.app/api/hospitals/${id}`)
                );
                ...
                const doctorPromises = categoryData.parentCategory.doctors.map((id) =>
                    axios.get(`https://code-commanders.vercel.app/api/doctors/${id}`)
                );
