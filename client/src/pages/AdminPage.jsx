...
const AdminPage = () => {
    ...
    const handleApprove = async (doctorId) => {
        ...
        try {
            await axios.post(`https://code-commanders.vercel.app/api/doctors/${doctorId}/approve`);
            setDoctors(
                doctors.map((doctor) =>
    ...
    const handleReject = async (doctorId) => {
        ...
        try {
            const response = await axios.post(
                `https://code-commanders.vercel.app/api/doctors/${doctorId}/reject`,
                { customMessage }
            );
    ...
    const handleApproveHospital = async (hospitalId) => {
        ...
        try {
            await axios.post(`https://code-commanders.vercel.app/api/hospitals/${hospitalId}/approve`);
            setHospitals(
